...
//!   spawning even concurrently from multiple threads, since [`Daemonizer`] is
...
//!   costs list); call [`detach_stdio`] to let go of the terminal's stdio once
...
//! is the [`protocol`] module's documentation.
//!
